  ...
  <div class="container">
    ...
    <div class="div-main-left-small">
      ...
      <div class="div-page-croll-left-main">
        ...
        <div class="div-child-view-Information-main">
          <ul>
            <a href="./student-view.html"><li><strong>></strong><i class="fa-solid fa-user"></i>Student</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-address-book"></i>Specialization</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-headphones-simple"></i>Class</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-paperclip"></i>Subject</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-table"></i>Score</li></a>
          </ul>
        </div>
        ...
        <div class="div-child-Information-Management">
          <ul>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-chalkboard-user"></i>Teacher Management</li></a>
            <a href="./student-view.php"><li><strong>></strong><i class="fa-solid fa-user-tie"></i>Student Management</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-paperclip"></i> Subject Management</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-receipt"></i> Mark Report</li></a>
          </ul>
        </div>
        ...
        <div class="div-child-Reports">
          <ul>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-book-bookmark"></i>Student Feedback</li></a>
            <a href="#"><li><strong>></strong><i class="fa-solid fa-question"></i>Q&A</li></a>
    ...
    <div class="div-main-right-big">
      ...
      <div class="div-child-right-big">
        <!-- Đây là phần div nhỏ được chia bên trái -->
        <div class="div-child-right-big-left">
          ...
          <div class="div-notify-main">
            <ul class="ul-notify-main">
              <a href="#">
                <li class="items-main"><span>15/01/24 15:32 -</span> Bảng học phí và các khoản phí tại Cao đẳng Anh quốc
                  BTEC - cơ sở Đà Nẵng (Theo QĐ số 08/QĐ-CTCPGDFPT ký ngày 12/1/2024)</li>
              </a>
              <a href="#">
                <li class="items-main"><span>21/12/23 21:33 -</span> [DVSV] THÔNG BÁO V/v TRIỂN KHAI TOOL ĐĂNG KÝ HỌC
                  LẠI MỚI</li>
              </a>
              <a href="#">
                <li class="items-main"><span>11/12/23 13:55 -</span> [P. TC&QLĐT] THÔNG BÁO KẾ HOẠCH HỌC TẬP HỌC KỲ
                  SPRING 2024 (ANNOUNCEMENT OF STUDY PLAN FOR SPRING SEMESTER 2024)</li>
              </a>
              <a href="#">
                <li class="items-main"><span>08/12/23 16:56 -</span> [KHẢO THÍ] THÔNG BÁO KẾ HOẠCH THI CUỐI KỲ PART 2
        ...
        <!-- Đây là phần div nhỏ được chia bên phải -->
        <div class="div-child-right-big-right">
          <img src="./imgs/pic1.svg" alt="">
        </div>
      </div>

      <!-- Đây sẽ là phần div banner center màu cam -->
      ...
      <div class="div-main-right-second">
        <!-- đây sẽ là phần bắt đầu của 2 div con bên trong div chaaa lớn -->

        <div class="div-child-items-second-left">
          <img src="./imgs/pic2.svg" alt="">
        </div>
        <div class="div-child-items-second-right">
          <h1>“However difficult life may seem, there is <strong>always something you can do</strong> and succeed at.”
          </h1>
          <p>STEVEN HAWKING</p>
          <!-- đây sẽ là phần bắt đầu của 2 div lastest bên trong div child right second -->
