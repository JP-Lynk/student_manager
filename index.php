    ...
    <!-- đây là div lớn của page login  -->
     ...
     <div class="div-flex-main">
        ...
        <div class="div-flex-child-left">
          ...
          <!-- đây là phần div login input + với btn login click -->
          ...
          <?php
                   if (isset($_POST['submit'])) {
                    ...
                    } elseif ($email == 'student@gmail.com' && $pass == '456098') {
                      echo "Đăng nhập với tư cách là student";
                        header('Location: homepage.php');
                        exit; // Đảm bảo không có mã HTML hoặc mã PHP nào được thực thi sau khi chuyển hướng
                    } elseif ($email == 'lecturers@gmail.com' && $pass == '789123') {
                      echo "Đăng nhập với tư cách là lecturers";
                      header('Location: homepage.php');
                      exit; // Đảm bảo không có mã HTML hoặc mã PHP nào được thực thi sau khi chuyển hướng
                    }
                }
